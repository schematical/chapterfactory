...
module.exports = function(app){
	var njaxSocket =  {
		...
		init:function(server){
			...
			var pub = redis.createClient(app.njax.env_config.redis.port, app.njax.env_config.redis.host, app.njax.env_config.redis);
			var sub = redis.createClient(app.njax.env_config.redis.port, app.njax.env_config.redis.host, app.njax.env_config.redis);
